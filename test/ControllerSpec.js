...
describe('controller', function () {
	...
	var setUpModel = function (todos) {
		// En chaînant l'espion avec and.callFake, tous les appels à l'espion( le model) seront délégués à la fonction fournie.
	...
	// creation  des espions sur le model, le view (render), et le controller
	beforeEach(function () {
		model = jasmine.createSpyObj('model', ['read', 'getCount', 'remove', 'create', 'update']);
		view = createViewStub();
		subject = new app.Controller(model, view);
	});
		//montre les entrées au démarrage de l'application
	it('should show entries on start-up', function () {
		// TODO: write test
		// au demarrage de l'appli la todo est vide
		var todo = '';
		// on configure le model avec le tableau créé
		setUpModel([todo]);
		//Au demarrage de l'appli la vue est initialisé a ''
		subject.setView('')
		// on verifie si le rendu de l'espion de la vue montre un todo vide 
	...
	describe('routing', function () {
		...
		it('should show all entries without a route', function () {
			...
			subject.setView('');
			//Le toHaveBeenCalledWithmatcher retournera true 
			//si la liste d'arguments correspond à l'un des appels enregistrés à l'espion
			expect(view.render).toHaveBeenCalledWith('showEntries', [todo]);
		});
		...
		it('should show active entries', function () {
			...
			// on verifie que le rendu de la vue  renvoie bien les taches complété
			expect(view.render).toHaveBeenCalledWith('showEntries', [todo]);
		});
		...
		it('should show completed entries', function () {
			...
			// on verifie que le rendu de la vue  renvoie bien les taches actives
			expect(view.render).toHaveBeenCalledWith('showEntries', [todo]);
		});
	});
	...
	it('should highlight "All" filter by default', function () {
		// TODO: write test
		// on configure le model avec un tableau vide
		var todo = ''
		setUpModel([todo]);
		//la vue est initialisé a '' lors du clic sur 'all'
		subject.setView('');
		// on verifie sur le view.render renvoie bien sur la page courante
	...
	it('should highlight "Active" filter when switching to active view', function () {
		...
		//la vue est initialisé a '' lors du clic sur 'all'
		subject.setView('#/active');
		// on verifie sur le view.render renvoie bien sur la page active
